        ...
        private val repository: MovieRepository) : PageKeyedDataSource<Int, Movie>()
{
    ...
    override fun loadInitial(params: LoadInitialParams<Int>, callback: LoadInitialCallback<Int, Movie>)
    {
        ...
        val error: Consumer<Throwable> = Consumer {
            networkState.postValue(NetworkState.Error(cause = it) { loadInitial(params, callback) })
        }
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, Movie>)
    {
        ...
        val error: Consumer<Throwable> = Consumer {
            networkState.postValue(NetworkState.Error(cause = it) { loadAfter(params, callback) })
        }
